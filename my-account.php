...
?>
    <main class="main__content_wrapper">
        ...
        <section class="my__account--section section--padding">
            <div class="container">
                <p class="account__welcome--text">Hello, <?php echo $_SESSION['user']?> welcome to your dashboard!</p>
...
while($row = mysqli_fetch_assoc($res)){
    ?>
     <tr class="account__table--body__child">
                                            <td class="account__table--body__child--items"><?php echo $row['orderID']; ?></td>
                                            <td class="account__table--body__child--items"><?php echo $row['orderDate']; ?></td>
                                     
                                            <td class="account__table--body__child--items">	<?php 
                        ...
                        ?></td>
                                            <td class="account__table--body__child--items">$<?php echo $row['orderAmount']; ?></td>
                                        </tr>
<?php 
