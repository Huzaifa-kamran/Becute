...
if(isset($_GET['status'])) {
    ...
    echo "<script> window.location.href = 'index.php' </script>";
        ...
        $passError = "Please Insert Correct Password";
        
      }
}else{
    $emailError = "No such a email registered on our website";
            ...
            if($_GET['status'] == 0) {
                ?>
                 <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        <strong>Please Login for place a order</strong>
                            ...
                            <div class="col d-flex justify-content-center">
                                ...
                                <div class="account__login">
                                    ...
                                    <div class="account__login--inner">
                                        <label>
                                            <input class="account__login--input" value="<?php echo @$_POST['loginEmail']?>" name="loginEmail" placeholder="Email Addres" type="email">
                                            <p class="text-danger"><?php echo @$emailError?></p>
                                        </label>
                                        <label>
                                            <input class="account__login--input" name="loginPassword" value="<?php echo @$_POST['loginPassword']?>" placeholder="Password" type="password">
                                        ...
                                        <p class="account__login--signup__text"> <a href="signup.php"> Don,t Have an Account? Sign up now </a></p>
                                    </div>
                                </div>
                                </form>
                            </div>
