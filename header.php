...
<body>
                ...
                <div class="header__topbar--inner style6 d-flex align-items-center justify-content-between">
                    ...
                    <div class="header__top--right d-flex align-items-center">
                        ...
                        <ul class="header__top--link d-flex align-items-center">
                            <li class="header__link--menu"><a class="header__link--menu__text" href="wishlist.php">
                    ...
                    <div class="header__menu d-none d-lg-block">
                        <nav class="header__menu--navigation">
                            <ul class="header__menu--wrapper d-flex">
                                ...
                                <li class="header__menu--items">
                                    <a class="header__menu--link" href="shop.php">Shop </a>  
                                </li>
                                <li class="header__menu--items">
                                    <a class="header__menu--link" href="blog.php">Categories
                      ...
                      if(mysqli_num_rows($categoryRes) > 0) {
                          while($row = mysqli_fetch_assoc($categoryRes)) {
                                        ?>
                                        <li class="header__sub--menu__items"><a href="shop.php?catID=<?php echo $row['catID'] ?>" class="header__sub--menu__link"><?php echo $row['catName'] ?></a></li>
                          <?php }}?>    
                                    </ul>
                                </li>
                                <li class="header__menu--items">
                    ...
                    <div class="header__account">
                        <ul class="header__account--wrapper d-flex align-items-center">
                            ...
                            <li class="header__account--items">
                                <a class="header__account--btn d-sm-2-none" href="wishlist.php">
                                    <span class="header__account--btn__icon">
                                        <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="header__account--items">
                                <a class="header__account--btn d-sm-2-none" href="my-account.php">
                                    <span class="header__account--btn__icon">
                                        <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="header__account--items header__minicart--items">
                                <a class="header__account--btn minicart__open--btn" href="cart.php" data-offcanvas>
                                    <span class="header__account--btn__icon">
                                        <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    if(isset($_SESSION['cart'])){
        ...
        echo $cart; // Remove the subtraction here
    } else {
        echo 0;
    }
    ?>
  ...
  <strong id="alertStatus"></strong> <span id="alertText"></span>
                ...
                <nav class="offcanvas__menu">
                    <ul class="offcanvas__menu_ul">
                      ...
                      if(mysqli_num_rows($categoryRes) > 0) {
                          while($row = mysqli_fetch_assoc($categoryRes)) {
                                        ?>
                                <li class="offcanvas__sub_menu_li"><a href="shop.php?catID=<?php echo $row['catID'] ?>" class="offcanvas__sub_menu_item"><?php echo $row['catName'] ?></a></li>
                                <?php }}?>
                            </ul>
                        </li>
                        <li class="offcanvas__menu_li">
                    ...
                    <div class="offcanvas__account--items">
                        <a class="offcanvas__account--items__btn d-flex align-items-center" href="login.php">
                            ...
                            <span class="offcanvas__account--items__label"><a href="login.php"> Login</a> | <a href="signup.php"> Register</a></span>
                        </a>
                    </div>
                </nav>
            </div>
        ...
        <div class="offcanvas__sticky--toolbar">
            <ul class="d-flex justify-content-between">
                ...
                <li class="offcanvas__sticky--toolbar__list">
                    <a class="offcanvas__sticky--toolbar__btn" href="shop.php">
                    <span class="offcanvas__sticky--toolbar__icon"> 
                ...
                <li class="offcanvas__sticky--toolbar__list">
                    <a class="offcanvas__sticky--toolbar__btn minicart__open--btn" href="cart.php" data-offcanvas>
                        <span class="offcanvas__sticky--toolbar__icon"> 
    ...
    ?>
                ...
                <li class="offcanvas__sticky--toolbar__list">
                    <a class="offcanvas__sticky--toolbar__btn" href="wishlist.php">
                        <span class="offcanvas__sticky--toolbar__icon"> 
        ...
        <div class="predictive__search--box ">
            <div class="predictive__search--box__inner">
                ...
                <form class="predictive__search--form" action="search.php" method="get">
                    <label>
                        <input class="predictive__search--input" name="searchPro" id="search" placeholder="Search Here" type="text">
                    </label>
                    <button class="predictive__search--button text-white" type="submit" name="search" aria-label="search button"><svg class="product__items--action__btn--svg" xmlns="http://www.w3.org/2000/svg" width="30.51" height="25.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"/></svg>  </button>
                </form>
            </div>
