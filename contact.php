...
if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO `feedbacks` (`firstName`, `lastName`, `contact`, `email`, `message`, `time`) 
    VALUES ('$firstName', '$lastName', '$contact', '$email', '$comment', current_timestamp())" ;
    $res = mysqli_query($conn,$query);
    if($res){
        echo "<script> window.location.href = 'contact.php?action=success' </script>";
    }
    }
...
<script>
    function validateForm() {
        ...
        const phoneNumber = document.getElementById('input3').value.trim();
        const email = document.getElementById('input4').value.trim();
        const message = document.getElementById('input5').value.trim();
    ...
    function isValidName(name) {
        // Use a regular expression to check if the name contains any numbers
        const nameRegex = /^[^\d]+$/;
...
<main class="main__content_wrapper">
        ...
        if(isset($_GET['action'])){
            if($_GET['action'] == "success"){
                ...
                <strong>Feedback Submit Successfully</strong>
        ...
        <section class="contact__section section--padding">
            <div class="container">
                <div class="contact__section--heading text-center mb-40">
                    <h2 class="contact__section--heading__maintitle">Get In Touch <?php echo @$message ?></h2>
                ...
                <div class="main__contact--area position__relative">
                    <div class="contact__form">
                        ...
                        <form class="contact__form--inner" onsubmit="return validateForm()" action="<?php echo $_SERVER['PHP_SELF']?>" method="post">
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        <label class="contact__form--label" for="input1">First Name <span class="contact__form--label__star">*</span></label>
                                        <input class="contact__form--input" name="firstname" id="input1" placeholder="Your First Name" type="text" required>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        <label class="contact__form--label" for="input2">Last Name <span class="contact__form--label__star">*</span></label>
                                        <input class="contact__form--input" name="lastname" id="input2" placeholder="Your Last Name" type="text" required>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        <label class="contact__form--label" for="input3">Phone Number <span class="contact__form--label__star">*</span></label>
                                        <input class="contact__form--input" name="contact" id="input3" placeholder="Phone number" type="text" required>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        <label class="contact__form--label" for="input4">Email <span class="contact__form--label__star">*</span></label>
                                        <input class="contact__form--input" name="email" id="input4" placeholder="Email" type="text" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="contact__form--list mb-15">
                                        <label class="contact__form--label" for="input5">Write Your Message <span class="contact__form--label__star">*</span></label>
                                        <textarea class="contact__form--textarea" name="message" value="" id="input5" placeholder="Write Your Message" required></textarea>
                                    </div>
                                </div>
                            </div>
                            
                            <button class="contact__form--btn primary__btn" type="submit" name="submit">
