...
if(isset($_POST['proId'])){
  ...
  $proQuery = "SELECT * FROM `products` WHERE `proID` = $id";
  $proRes = mysqli_query($conn, $proQuery);
  $data = mysqli_fetch_assoc($proRes);

  $output = "abcd";

  $output .= '<div class="modal-dialog quickview__main--wrapper modal-dialog-centered">
            ...
            <div class="col">
                <div class="quickview__info">
                    <form action="#">
                        ...
                        <p class="product__details--info__desc mb-15">'.$data['proDesc'].'</p>
