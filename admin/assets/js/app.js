...
$(function() {
	...
	function toggleDarkMode() {
	  var darkModeIcon = $(".dark-mode-icon i");
	  if (darkModeIcon.attr("class") === "bx bx-sun") {
	...
	// Function to set the sidebar color
	function setSidebarColor(color) {
	  $(".sidebar-wrapper").attr("class", "sidebar-wrapper " + color);
	...
	// Check if a sidebar color is stored in local storage
	var storedSidebarColor = localStorage.getItem("sidebarColor");
	if (storedSidebarColor) {
	  setSidebarColor(storedSidebarColor);
	  $(".sidebar-color-indicator[data-color='" + storedSidebarColor + "']").addClass("active");
	}
  
	$(".dark-mode").on("click", toggleDarkMode);
  
	// Handle sidebar color click event
	$(".sidebar-color-indicator").on("click", function() {
	  var color = $(this).data("color");
	  $(".sidebar-color-indicator").removeClass("active");
	...
	$(function() {
	  for (var e = window.location, o = $(".metismenu li a")
		  .filter(function() {
			return this.href == e;
		  })
		  .addClass("")
		  .parent()
		  .addClass("mm-active"); o.is("li"); )
		o = o.parent("")
		  .addClass("mm-show")
		  .parent("")
		  .addClass("mm-active");
	...
	function theme1() {
	  $('html').attr('class', 'color-sidebar sidebarcolor1');
	  setSidebarColor('sidebarcolor1');
	}
  
	function theme2() {
	  $('html').attr('class', 'color-sidebar sidebarcolor2');
	  setSidebarColor('sidebarcolor2');
	}
	...
	function theme4() {
	  $('html').attr('class', 'color-sidebar sidebarcolor4');
	  setSidebarColor('sidebarcolor4');
	}
  
	function theme5() {
	  $('html').attr('class', 'color-sidebar sidebarcolor5');
	  setSidebarColor('sidebarcolor5');
	}
  
	function theme6() {
	  $('html').attr('class', 'color-sidebar sidebarcolor6');
	  setSidebarColor('sidebarcolor6');
	}
  
	function theme7() {
	  $('html').attr('class', 'color-sidebar sidebarcolor7');
	  setSidebarColor('sidebarcolor7');
	}
  
	function theme8() {
	  $('html').attr('class', 'color-sidebar sidebarcolor8');
	  setSidebarColor('sidebarcolor8');
	}
