...
?>
    ...
    // Fetch and display the product details for each item in the wishlist
...
<tr class="cart__table--body__items">
                                        <td class="cart__table--body__list">
                                            ...
                                            <form action="removeFromWishlist.php" method="post">
                                                            <input type="hidden" name="product_id" value="<?php echo $productDetails['proID']; ?>">
                                                ...
                                                <div class="cart__thumbnail">
                                                    <a href="product-details.html"><img class="border-radius-5" src="admin/assets/images/products/<?php echo $productDetails['img1']; ?>" alt="cart-product"></a>
                                                </div>
                                                <div class="cart__content">
                                                    <h3 class="cart__content--title h4"><a href="product-details.html"><?php echo $productDetails['proName'];?></a></h3>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="cart__table--body__list">
                                            <span class="cart__price">$<?php echo $productDetails['sellPrice'];?></span>
                                        </td>
                                    ...
                                    <div>
                                    <input type="hidden" name="proID" value="<?php echo  $productDetails['proID']; ?>">
                                    <input type="hidden" name="quantity" value="1">
                                <button class="primary__btn quickview__cart--btn" name="addToCart" type="submit" >Add To Cart</button>  
                                    </div>
                                    </form>
                                        </td>
                                    </tr>
